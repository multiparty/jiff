...
Description and guide for bubble sort on joint input lists with secure MPC.

## Protocol
Each party inputs an array of length n. The protocol concatenates these arrays, and outputs the result sorted via bubblesort.
