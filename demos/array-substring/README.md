...
The implementation of this protocol is located in <a href="https://github.com/multiparty/jiff/blob/master/demos/array-substring/mpc.js">mpc.js</a>.
...
**2. Run from the command line ⌨️ (without visual demos)**
    ...
    ```shell
    npx cypress run --config-file demos/cypress.config.ts --spec "demos/array-substring/test.cy.ts"
    ```
