(function(exports, node) {
     ...
     * The MPC computation
     */
    function optimized_eq_check_answers(p_guesses, p_ships){
        let answers = [];
        // 1 = miss
        // 0 = hit
        for (let g = 0; g < p_guesses.length; g++) {
           ...
           answers[g] = answers[g].ceq(0); // if equal then 1, else 0
        }
    ...
    exports.share_guesses = function (input, jiff_instance) {
        ...
        promise_guesses.then(function(res_guesses) {
            ...
            p1_answers = optimized_eq_check_answers(guesses[1], ships[2]);
            console.log('about to check p2 answers');
            p2_answers = optimized_eq_check_answers(guesses[2], ships[1]);
