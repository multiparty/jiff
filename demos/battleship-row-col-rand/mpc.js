(function(exports, node) {
     ...
     * The MPC computation
     */
    function row_col_rand_check_answers(p_guesses, p_ships){
        // any number = miss
        // 0 = hit
    ...
    exports.share_guesses = function (input, jiff_instance) {
        ...
        promise_guesses.then(function(res_guesses) {
            ...
            p1_answers = row_col_rand_check_answers(guesses[1], ships[2]);
            console.log('about to check p2 answers');
            p2_answers = row_col_rand_check_answers(guesses[2], ships[1]);
