...
function connect() {
  ...
  var preprocess_count = parseInt($('#preprocess_count').val());

  if (isNaN(party_count) || isNaN(preprocess_count)) {
    $('#output').append("<p class='error'>Party count and Preprocess count must be a valid numbers!</p>");
    ...
    options.onConnect = function () {
      ...
      $('#output').append('<p>Begin Preprocessing...</p>');
