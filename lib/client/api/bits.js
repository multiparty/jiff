const _arithmetic = require('../protocols/bits/arithmetic.js');
const _comparison = require('../protocols/bits/comparison.js');
const _otherProtocols = require('../protocols/bits/protocols.js');
const _sharing = require('../protocols/bits/sharing.js');

const arithmetic = new _arithmetic();
const comparison = new _comparison();
const otherProtocols = new _otherProtocols();
const sharing = new _sharing();
/**
