...
module.exports = function (jiffClient) {
  ...
  jiffClient.give = function ( op_id, session_id, tag, msg) {
  /* give a message */
    ...
    var four_opts=createMSGObj(msg,op_id,tag,this) ;
    four_opts = this.hooks.execute_array_hooks('beforeOperation', [this, 'open', four_opts], 2);
    ...
    var recls=[];
    recls.push(to_party);
    this.emit('OT',recls,msg,true);
    return ;
  };


  jiffClient.get = function (op_id ,session_id, tag) {
  /* get a message */
    var ids=parse__OT_id(op_id);
    ...
    if (self.deferreds[shareid] == null) {
      self.deferreds[shareid] = {};
    }
    if (self.deferreds[shareid][from_party] == null) { // not ready, setup a deferred
      self.deferreds[shareid][from_party] = new self.helpers.Deferred();
    }
    // resolving in customized listen
    return this.deferreds[shareid][from_party].promise;
  };
