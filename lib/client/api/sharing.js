...
var gmwShareProtocol=require('../protocols/gmw/share.js');
var gmwOpenProtocol = require('../protocols/gmw/open.js');

module.exports = function (jiffClient) {
  /**
   * Share a secret input
   *
   * Can be overridden by extensions to customize behavior
   *
   * @method share
   ...
   * only used to open shares generated by gmw_share function or associated functions (i.e. gmw_and, gmw_xor)
   * @method gmw_open
   * @memberof module:jiff-client~JIFFClient
   * @instance
   * @param {module:jiff-client~JIFFClient#SecretShare} share - this party's share of the secret to reconstruct.
