...
Hooks.prototype.getPreprocessing = function(jiffClient, op_id) {
  return jiffClient.get_preprocessing(op_id); 
}
Hooks.prototype.storePreprocessing = function(jiffClient, op_id, share) {
  return jiffClient.store_preprocessing(op_id, share);
}
