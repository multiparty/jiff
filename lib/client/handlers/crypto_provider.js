...
module.exports = function (jiffClient) {
  ...
  jiffClient.handlers.receive_crypto_provider = function (json_msg) {
    // Hook
    json_msg = jiffClient.execute_array_hooks('afterOperation', [jiffClient, 'crypto_provider', json_msg], 2);
    ...
    if (json_msg['shares'] != null) {
      ...
      for (var i = 0; i < json_msg['shares'].length; i++) {
        result.shares.push(jiffClient.secret_share(jiffClient, true, null, json_msg['shares'][i], receivers_list, threshold, Zp));
      }
    }
