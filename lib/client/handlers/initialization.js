...
module.exports = function (jiffClient) {
  ...
  jiffClient.handlers.build_initialization_message = function () {
    ...
    // Initialization Hook
    return jiffClient.execute_array_hooks('beforeOperation', [jiffClient, 'initialization', msg], 2);
  };
  ...
  jiffClient.handlers.connected = function () {
    ...
    var msg = jiffClient.build_initialization_message();
  ...
  jiffClient.handlers.initialized = function (msg) {
    ...
    msg = JSON.parse(msg);
    msg = jiffClient.execute_array_hooks('afterOperation', [jiffClient, 'initialization', msg], 2);
    ...
    jiffClient.store_public_keys(msg.public_keys);
  };
