...
module.exports = function (jiffClient) {
   ...
   * deferred if needed.
   * @method
   * @memberof module:jiff-client.JIFFClient.handlers
  ...
  jiffClient.handlers.receive_share = function (json_msg) {
    ...
    json_msg = jiffClient.execute_array_hooks('afterOperation', [jiffClient, 'share', json_msg], 2);
    ...
    // Call hook
    share = jiffClient.execute_array_hooks('receiveShare', [jiffClient, sender_id, share], 2);
  ...
  jiffClient.handlers.receive_open = function (json_msg) {
    ...
    if (json_msg['party_id'] !== jiffClient.id) {
      json_msg['share'] = jiffClient.hooks.decryptSign(jiffClient, json_msg['share'], jiffClient.secret_key, jiffClient.keymap[json_msg['party_id']]);
      json_msg = jiffClient.execute_array_hooks('afterOperation', [jiffClient, 'open', json_msg], 2);
    }
    ...
    // call hook
    share = jiffClient.execute_array_hooks('receiveOpen', [jiffClient, sender_id, share, Zp], 2);
