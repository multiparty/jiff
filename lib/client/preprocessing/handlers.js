...
module.exports = {
  ...
  dynamic_random_and_quotient: function (dependent_op, count, protocols, threshold, receivers_list, compute_list, Zp, task_id, params, task, jiff) {
    ...
    let newParams = { compute_threshold: params.compute_threshold };
    ...
    let largestQuotient = jiff.share_helpers['floor'](jiff.share_helpers['/'](Zp, params.constant));
  ...
  dynamic_fast_exponentiation: function (dependent_op, count, protocols, threshold, receivers_list, compute_list, Zp, task_id, params, task, jiff) {
    Zp = Zp ? Zp : jiff.Zp;
    let constantNotProvided = params.constant == null;
    let constant = params.constant;
    let constantBits = params.constantBits == null ? Zp.toString(2).length : params.constantBits;
