module.exports = function (jiffClient) {
  ...
  jiffClient.preprocessing_function_map = {
    base: {
      ...
      'lt_halfprime': [
        {op: 'rejection_sampling', op_id: ':sampling'},
        {op: 'smult', op_id: ':smult1'},
      ...
      '__generate_random_and_quotient': [
        ...
        {op: 'rejection_sampling', op_id: ':rejection1'}
      ],
      // rejection sampling
  ...
  jiffClient.preprocessing_function_map['base']['seq'] = jiffClient.preprocessing_function_map['base']['clteq'];
  jiffClient.preprocessing_function_map['base']['sneq'] = jiffClient.preprocessing_function_map['base']['seq'];
  jiffClient.preprocessing_function_map['base']['ceq'] = jiffClient.preprocessing_function_map['base']['clteq'];
  jiffClient.preprocessing_function_map['base']['cneq'] = jiffClient.preprocessing_function_map['base']['ceq'];
