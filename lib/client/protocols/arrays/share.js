  ...
  share_array_single_sender = (jiff, secrets, threshold, receivers_list, sender, Zp, share_id) => {
    if (secrets != null && secrets.length === 0) {
      ...
      for (let j = 0; j < secrets.length; j++) {
        const curr_sec = secrets[parseInt(j, 10)];
        promised_array.push(this.share_array_single_sender(jiff, curr_sec, threshold, receivers_list, sender, Zp, share_id + ':' + j));
      }
