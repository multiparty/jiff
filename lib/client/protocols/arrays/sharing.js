module.exports = {
  ...
  jiff_share_from_skeleton : function (jiff, ths, sender, skeleton) {
    let shares;
    ...
    let promise = jiff.share_array_single_sender(shares, ths.threshold, ths.receivers_list, sender, ths.Zp, ths.share_id + ':p_id_' + sender);

    promise.then(function (sender, array) {
      ths.deferreds[sender].resolve(array);
    }.bind(null, sender));
  },
  ...
  jiff_share_ND_array : function (jiff, secrets, skeletons, threshold, receivers_list, senders_list, Zp, share_id) {
    ...
    // }
    jiff.share_from_skeleton = jiff.share_from_skeleton.bind(null, {
