...
const share_ND_array_deferred = function (jiff, secrets, skeletons, threshold, receivers_list, senders_list, Zp, share_id) {
  ...
  [receivers_list, senders_list, threshold, Zp, share_id] = sanitize_array_params.bind(null, jiff).apply(null, parameters);
  ...
  const share_from_skeleton = function (sender, skeleton) {
    return share_from_skeleton_unbound(jiff, opt, sender, skeleton);
  };
