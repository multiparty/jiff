module.exports = {
  ...
  jiff_share_from_skeleton_unbound : function (jiff, that, sender, skeleton) {
    ...
    var promise = jiff.share_array_single_sender(shares, that.threshold, that.receivers_list, sender, that.Zp, that.share_id + ':p_id_' + sender);
  ...
  jiff_skeleton_of : function (jiff, nd_array, replace) {
  ...
  jiff_share_ND_array : function (jiff, secrets, skeletons, threshold, receivers_list, senders_list, Zp, share_id) {
    var share_ND_array = skeletons != null ? jiff.share_ND_array_static : jiff.share_ND_array_deferred;
  ...
  jiff_receive_open_ND_array : function (jiff, parties, threshold, Zp, op_ids) {
    return jiff.open_ND_array(null, parties, null, op_ids);
  }
};
