module.exports = {
  ...
  csubl: function (jiff, bits, constant, op_id) {
    ...
    // decompose constant into bits
    let constant_bits = jiff.helpers.number_to_bits(constant, bits.length); // pads with zeros to bits.length
  ...
  smult: function (jiff, bits1, bits2, op_id) {
    ...
    jiff.utils.bit_combinator(
      ...
      function (i, intermediate) {
        ...
        let bit_mult = []; // add bits1 or 0 to the result according to this bit
