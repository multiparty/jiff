module.exports = {
  ...
  rejection_sampling: function (jiff, lower_bound, upper_bound, threshold, parties, Zp, op_id) {
    ...
    const result = jiff.preprocess.get_preprocessing(op_id);
    ...
    if (result == null) {
      ...
      jiff.preprocess.preprocessing('rejection_sampling', 1, null, threshold, parties, parties, Zp, [op_id], {
        lower_bound: lower_bound,
        upper_bound: upper_bound
      });
      jiff.preprocess.executePreprocessing(function () {
        jiff.utils.resolve_many_secrets(final_deferreds, jiff.preprocess.get_preprocessing(op_id));
      });
    }
