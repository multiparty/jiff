...
module.exports = function (SecretShare) {
  ...
  SecretShare.prototype.smult = function (o, op_id) {
    ...
    const triplet = this.jiff.preprocess.get_preprocessing(op_id + ':triplet');
    if (triplet == null) {
  ...
  SecretShare.prototype.cdiv = function (cst, op_id) {
    ...
    // Preprocessing cases
    const quotient = this.jiff.preprocess.get_preprocessing(op_id + ':quotient');
    if (quotient == null) {
      ...
      this.jiff.preprocess.preprocessing('quotient', 1, null, this.threshold, this.holders, this.holders, this.Zp, [op_id + ':quotient'], { constant: cst, namespace: 'base' });
      this.jiff.preprocess.executePreprocessing(function () {
        const quotient = self.jiff.preprocess.get_preprocessing(op_id + ':quotient');
