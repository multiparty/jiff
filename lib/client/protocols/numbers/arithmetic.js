...
module.exports = function (SecretShare) {
  ...
  SecretShare.prototype.smult = function (o, op_id) {
    ...
    var triplet = this.jiff.hooks.getPreprocessing(this.jiff, op_id + ':triplet');
    if (triplet == null) {
  ...
  SecretShare.prototype.cdiv = function (cst, op_id) {
    ...
    // Preprocessing cases
    var quotient = this.jiff.hooks.getPreprocessing(this.jiff, op_id + ':quotient');
    if (quotient == null) { // case 1: no preprocessing with crypto provider!
      ...
      this.jiff.executePreprocessing(function () {
        var quotient = self.jiff.hooks.getPreprocessing(self.jiff, op_id + ':quotient');
