...
module.exports = function (SecretShare) {
  ...
  SecretShare.prototype.smult = function (o, op_id) {
    ...
    const triplet = this.jiff.get_preprocessing(op_id + ':triplet');
    if (triplet == null) {
  ...
  SecretShare.prototype.cdiv = function (cst, op_id) {
    ...
    // Preprocessing cases
    const quotient = this.jiff.get_preprocessing(op_id + ':quotient');
    if (quotient == null) {
      ...
      this.jiff.executePreprocessing(function () {
        const quotient = self.jiff.get_preprocessing(op_id + ':quotient');
