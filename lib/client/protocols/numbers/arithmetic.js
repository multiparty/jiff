...
module.exports = function (SecretShare) {
  ...
  SecretShare.prototype.cadd = function (cst) {
    ...
    return new this.jiff.SecretShare(this.value.wThen(ready), this.holders, this.threshold, this.Zp);
  };
  ...
  SecretShare.prototype.smult_bgw = function (o, op_id) {
    ...
    return this.jiff.protocols.reshare(result, Math.max(this.threshold, o.threshold), result.holders, result.holders, result.Zp, op_id + ':threshold');
  };
  ...
  SecretShare.prototype.cdiv = function (cst, op_id) {
    ...
    if (quotient == null) { // case 1: no preprocessing with crypto provider!
      ...
      var ondemand = this.jiff.protocols.generate_random_and_quotient(this.threshold, this.holders, this.holders, this.Zp, {
