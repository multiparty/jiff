class SocketEvent {
  ...
  initSocket = function () {
    ...
    this.jiffClient.socket.on('share', (msg, callback) => {
      ...
      if (this.jiffClient.keymap[sender_id] != null) {
        ...
        this.jiffClient.messagesWaitingKeys[sender_id].push({ label: 'share', msg: json_msg });
      }
    });
    ...
    this.jiffClient.socket.on('open', (msg, callback) => {
      ...
      if (this.jiffClient.keymap[sender_id] != null) {
        ...
        this.jiffClient.messagesWaitingKeys[sender_id].push({ label: 'open', msg: json_msg });
      }
    });
    ...
    this.jiffClient.socket.on('custom', (msg, callback) => {
      ...
      if (this.jiffClient.keymap[sender_id] != null || encrypted !== true) {
        ...
        this.jiffClient.messagesWaitingKeys[sender_id].push({ label: 'custom', msg: json_msg });
      }
    });
  ...
  resolve_messages_waiting_for_keys() {
    for (let party_id in this.jiffClient.keymap) {
      ...
      const messageQueue = this.jiffClient.messagesWaitingKeys[party_id];
