/**
 * Contains utilty functions (higher order combinators)
 * @name utils
 * @alias utils
 * @namespace
 */
...
module.exports = function (jiffClient) {
  ...
  jiffClient.utils.many_secret_shares = function (count, holders, threshold, Zp) {
    ...
    for (var i = 0; i < count; i++) {
      ...
      shares.push(jiffClient.secret_share(jiffClient, false, deferred.promise, undefined, holders, threshold, Zp));
