...
* `encryptSign[Single]: function(instance, message, encryption_public_key, signing_private_key, operation_type)`
  * `instance`: the JIFF instance
...
* `decryptSign[Single]: function(instance, cipher_text, decryption_secret_key, signing_public_key, operation_type)`
  * `instance`: the JIFF instance
