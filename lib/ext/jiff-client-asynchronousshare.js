...
(function (exports, node) {
  ...
  function createMultipleSharesSecretShare(jiff, share, share_helpers) {
     ...
     */
    share.clone = function (ready, promise, value) {
      return share.jiff.secret_share(share.jiff, ready, promise, value, share.holders, share.threshold, share.Zp, null, share.ratios);
    };
    ...
    share.sadd = function (o) {
      ...
      if (share.ready && o.ready) {
        var clone = share.clone(true, null, ready_add());
      ...
      var clone = share.clone(false, promise, null);
      clone.threshold = max(share.threshold, o.threshold);
      return clone;
    };
    ...
    share.ssub = function (o) {
      ...
      if (share.ready && o.ready) {
        var clone = share.clone(true, null, ready_sub());
        clone.threshold = max(share.threshold, o.threshold);
        return clone;
      }
    ...
    share.smult = function (o, op_id) {
      ...
      var result = share.clone(false, final_promise, null);
      result.threshold = max(share.threshold, o.threshold);
      result.id = 'share' + op_id;
