...
(function (exports, node) {
  ...
  function createMultipleSharesSecretShare(jiff, share, share_helpers) {
    ...
    /** Creates a clone of the share with same properties (holders, threshold, etc.)
     */
    share.secret_clone = function(ready, promise, value, threshold, holders, Zp, id, ratios) {
      var threshold = threshold == undefined ? share.threshold : threshold;
      var holders = holders == undefined ? share.holders : holders;
      var Zp = Zp == undefined ? share.Zp : Zp;
      var id = id == undefined ? null : id;
      var ratios = ratios == undefined ? share.ratios : ratios;

      var clone = jiff.secret_share(share.jiff, ready, promise, value, holders, threshold, Zp, id, ratios);
      return clone;
    };
    ...
    share.cadd = function (o) {
      ...
      if (share.ready) {
        return share.secret_clone(true, null, ready_add());
      }

      var promise = share.promise.then(function () {
        return ready_add();
      }, share.error);
      return share.secret_clone(false, promise, null);
    };

    share.sadd = function (o) {
      (share.jiff.helpers.shares_compatible(share, o));
      if (!share.jiff.helpers.ratios_equals(share.ratios, o.ratios)) {
        throw new Error('shares must have the same ratios');
      }
      ...
      if (share.ready && o.ready) {
        return share.secret_clone(true, null, ready_add(), max(share.threshold, o.threshold));
      }

      var promise = share.pick_promise(o).then( function () {
        return ready_add();
      }, share.error);
      return share.secret_clone(false, promise, null, max(share.threshold, o.threshold));
    };
    ...
    share.csub = function (o) {
      ...
      if (share.ready) {
        return share.secret_clone(true, null, ready_sub());
      }
    ...
    share.ssub = function (o) {
      ...
      if (share.ready && o.ready) {
        return share.secret_clone(true, null, ready_sub(), max(share.threshold, o.threshold));
      }
    ...
    share.cmult = function (o) {
      ...
      if (share.ready) {
        return share.secret_clone(true, null, ready_mult());
      }
    ...
    share.smult = function (o, op_id) {
      ...
      var result = share.secret_clone(false, final_promise, undefined, max(share.threshold, o.threshold), undefined, undefined, 'share:' + op_id);
    ...
    share.smult_bgw = function(o, op_id) {
      ...
      var ready_mult_bgw = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          var share_tmp = share.secret_clone(true, null, share.value[i]);
          var o_tmp = o.secret_clone(true, null, o.value[i]);
      ...
      if (share.ready && o.ready) {
        ready_mult_bgw();
        return share.secret_clone(false, final_promise, undefined, max(share.threshold, o.threshold));
      }
    ...
    share.cdivfac = function (o) {
      ...
      if (share.ready) {
        // If share is ready.
        return share.secret_clone(true, null, ready_cdivfac());
      }

      var promise = share.promise.then(function () {
        return ready_cdivfac();
      }, share.error);
      return share.secret_clone(false, promise, undefined);
    };
    ...
    share.lt_halfprime = function (op_id) {
      ...
      var final_deferred = $.Deferred();
      var final_promise = final_deferred.promise();
      var result = share.secret_clone(false, final_promise, undefined, undefined, undefined, undefined, 'share:' + op_id);
  ...
  function make_jiff(base_instance, options) {
     ...
     */
    jiff.helpers.shares_compatible = function (s1, s2){
      if (!(s2.jiff === s1.jiff)) {
    ...
    jiff_server_share_number = function (jiff, options, receivers_list, threshold, Zp, number_id, ratios) {
      if (Zp == null) {
        Zp = jiff.Zp;
      }
      if (receivers_list == null) {
      ...
      var msg = {number_id: number_id, receivers: receivers_list, threshold: threshold, Zp: Zp, ratios: ratios};
      ...
      for (i = 0; i < options.count; i++) {
        ...
        shares[i] = jiff.secret_share(jiff, false, deferred.promise(), undefined, receivers_list, threshold, Zp, number_id + ':' + i, ratios);
      }
    ...
    jiff.server_generate_and_share = function (options, receivers_list, threshold, Zp, number_id, ratios) {
      return jiff_server_share_number(jiff, options, receivers_list, threshold, Zp, number_id, ratios);
    };
