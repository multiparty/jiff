...
(function (exports, node) {
   ...
   */
  exports.name = 'asynchronousshare';
  ...
  function createMultipleSharesSecretShare(jiff, share, share_helpers) {
    ...
    share.cadd = function (o) {
      ...
      var promise = share.promise.then( function () {
        if (typeof (share.value) === 'number') {
          return share.legacy.cadd(o).value;
        } else {
          return ready_add();
        }
      }, share.error);
    ...
    share.csub = function (o) {
      ...
      var promise = share.promise.then( function () {
        if (typeof (share.value) === 'number') {
          return share.legacy.csub(o).value;
        } else {
          return ready_sub();
        }
      }, share.error);
    ...
    share.cmult = function (o) {
      ...
      var promise = share.promise.then( function () {
        if (typeof (share.value) === 'number') {
          return share.legacy.cmult(o).value;
        } else {
          return ready_mult();
        }
      }, share.error);
    ...
    share.smult_bgw = function(o, op_id) {
      ...
      var promise = share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          multshare = share.legacy.smult_bgw(o);
          if (multshare.ready) {
            return multshare.value;
          } else {
            result = multshare.promise.then(function () {
    ...
    share.cdiv = function (o, op_id) {
      var ready_div = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.cdiv(o, op_id).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.cdiv(o, op_id).value;
        } else {
    ...
    share.cdivfac = function (o) {
      var ready_div = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.cdivfac(o).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.cdivfac(o).value;
        } else {
          return share.jiff.secret_share(share.jiff, true, null, ready_div(), share.holders, share.threshold, share.Zp);
        }
      }
    ...
    share.smod = function (o, l, op_id) {
      var mult_deferred = new Deferred();
      var finalpromise = mult_deferred.promise;
      ...
      var ready_mod = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.smod(o, l, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          var result = share.legacy.smod(o, l, op_id);
          result.promise.then(function () {
            mult_deferred.resolve(result.value);
          });
        } else {
          mult_deferred.resolve(ready_mod());
        }
      }, share.error);
    ...
    share.cxor_bit = function (o) {
      var ready_xor_bit = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.cxor_bit(o).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.cxor_bit(o).value;
        } else {
    ...
    share.sxor_bit = function (o, op_id) {
      ...
      var ready_xor_bit = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.sxor_bit(o, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          var result = share.legacy.sxor_bit(o, op_id);
          result.promise.then(function () {
            mult_deferred.resolve(result.value);
          });
        } else {
          mult_deferred.resolve(ready_xor_bit());
        }
      }, share.error);
      return share.jiff.secret_share(share.jiff, false, finalpromise, undefined, share.holders, max(share.threshold, o.threshold), share.Zp);
    };
    ...
    share.cor_bit = function (o) {
      var ready_or_bit = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.cor_bit(o).value);
        }
        share.value = share_val;
        return result;
      };
    ...
    share.sor_bit = function (o, op_id) {
      ...
      var ready_or_bit = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.sor_bit(o, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          var result = share.legacy.sor_bit(o, op_id);
          result.promise.then(function () {
            mult_deferred.resolve(result.value);
          });
        } else {
          mult_deferred.resolve(ready_or_bit());
        }
      }, share.error);
      return share.jiff.secret_share(share.jiff, false, finalpromise, undefined, share.holders, max(share.threshold, o.threshold), share.Zp);
    };
    ...
    share.clt = function (o, op_id) {
      var ready_lt = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.clt(o, op_id).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.clt(o, op_id).value;
        } else {
    ...
    share.clteq = function (o, op_id) {
      var ready_lteq = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.clteq(o, op_id).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.clteq(o, op_id).value;
        } else {
    ...
    share.cgt = function (o, op_id) {
      var ready_gt = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.cgt(o, op_id).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.cgt(o, op_id).value;
        } else {
    ...
    share.cgteq = function (o, op_id) {
      var ready_gteq = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.cgteq(o, op_id).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.cgteq(o, op_id).value;
        } else {
    ...
    share.ceq = function (o, op_id) {
      var ready_eq = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.ceq(o, op_id).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.ceq(o, op_id).value;
        } else {
    ...
    share.cneq = function (o, op_id) {
      var ready_neq = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.cneq(o, op_id).value);
        }
        share.value = share_val;
        return result;
      };
    ...
    share.slt = function (o, op_id) {
      ...
      var ready_lt = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.slt(o, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          ...
          mult_deferred.resolve(ready_lt());
        }
      }, share.error);
      return share.jiff.secret_share(share.jiff, false, finalpromise, undefined, share.holders, max(share.threshold, o.threshold), share.Zp);
    };
    ...
    share.slteq = function (o, op_id) {
      ...
      var ready_lteq = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.slteq(o, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          ...
          mult_deferred.resolve(ready_lteq());
        }
      }, share.error);
      return share.jiff.secret_share(share.jiff, false, finalpromise, undefined, share.holders, max(share.threshold, o.threshold), share.Zp);
    };
    ...
    share.sgt = function (o, op_id) {
      ...
      var ready_gt = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.sgt(o, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          ...
          mult_deferred.resolve(ready_gt());
        }
      }, share.error);
      return share.jiff.secret_share(share.jiff, false, finalpromise, undefined, share.holders, max(share.threshold, o.threshold), share.Zp);
    };
    ...
    share.sgteq = function (o, op_id) {
      ...
      var ready_gteq = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.sgteq(o, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          ...
          mult_deferred.resolve(ready_gteq());
        }
      }, share.error);
      return share.jiff.secret_share(share.jiff, false, finalpromise, undefined, share.holders, max(share.threshold, o.threshold), share.Zp);
    };
    ...
    share.seq = function (o, op_id) {
      ...
      var ready_eq = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.seq(o, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          ...
          mult_deferred.resolve(ready_eq());
        }
      }, share.error);
      return share.jiff.secret_share(share.jiff, false, finalpromise, undefined, share.holders, max(share.threshold, o.threshold), share.Zp);
    };
    ...
    share.sneq = function (o, op_id) {
      ...
      var ready_neq = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          o.value = o_val[i];
          result.push(share.legacy.sneq(o, op_id).value);
        }
        share.value = share_val;
        o.value = o_val;
        return result;
      ...
      share.pick_promise(o).then( function () {
        if (typeof (share.value) === 'number') {
          ...
          mult_deferred.resolve(ready_neq());
        }
      }, share.error);
      return share.jiff.secret_share(share.jiff, false, finalpromise, undefined, share.holders, max(share.threshold, o.threshold), share.Zp);
    };
    ...
    share.lt_halfprime = function (op_id) {
      var ready_lt_halfprime = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.lt_halfprime(op_id).value);
        }
        share.value = share_val;
        return result;
      };
      ...
      if (share.ready && o.ready) {
        if (typeof (share.value) === 'number') {
          return share.legacy.lt_halfprime(op_id).value;
        } else {
    ...
    share.not = function () {
      var ready_not = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.not().value);
        }
        share.value = share_val;
        return result;
      };
    ...
    share.if_else = function (trueVal, falseVal, op_id) {
      var ready_if_else = function () {
        ...
        for (var i = 0; i < share.value.length; i++) {
          share.value = share_val[i];
          result.push(share.legacy.if_else(trueVal, falseVal, op_id).value);
        }
        share.value = share_val;
        return result;
      };
