...
(function(exports, node) {
  ...
  function createSecretShare(jiff, share, share_helpers) {
    ...
    share_helpers['+'] = function(v1, v2) { return v1.plus(v2); };
    share_helpers['-'] = function(v1, v2) { return v1.minus(v2); };
    share_helpers['*'] = function(v1, v2) { return v1.times(v2); };
    share_helpers['/'] = function(v1, v2) { return v1.div(v2); };
    share_helpers['<'] = function(v1, v2) { return v2.gt(v1); };
    share_helpers['floor/'] = function(v1, v2) { return v1.div(v2).floor(); };
    share_helpers['pow'] = function(v1, v2) { return self.jiff.helpers.BigNumber(v1).pow(v2); };
    share_helpers['binary'] = function(v) { return v.toString() == "1" || v.toString() == "0"; };
  ...
  function make_jiff(base_instance, options) {
    ...
    if(jiff.modules.indexOf("negativenumber") > -1) {
      throw "Please apply bignumber before negative number extensions";
    }
    ...
    jiff.share = function(secret, threshold, receivers_list, senders_list, Zp, share_id) {
      secret = jiff.helpers.BigNumber(secret);
      if (!secret.floor().eq(secret) || secret.lt(0)) {
        throw 'secret must be a non-negative whole number';
      }
      if(secret.gte(Zp == null ? jiff.Zp : Zp)) {
