...
(function (exports, node) {
  ...
  function createFixedpointSecretShare(jiff_instance, share, share_helpers) {
    ...
    share.smod = function (o, l, op_id) {
      ...
      return share.ssub(floorQuotient.legacy.smult(o, op_id+':smult'));
    };
    ...
    share.sxor_bit = function (o, op_id) {
      ...
      var reduced_xor = reduced_share.sadd(reduced_o).ssub(reduced_share.smult(reduced_o, op_id, false).cmult(2));
    ...
    share.sor_bit = function (o, op_id) {
      ...
      var reduced_share = share.cdivfac(magnitude);
      var reduced_o = o.cdivfac(magnitude);
      var reduced_or = reduced_share.sadd(reduced_o).ssub(reduced_share.smult(reduced_o, op_id, false));
