...
(function (exports, node) {
  ...
  function make_jiff(base_instance, options) {
    ...
    base_instance.helpers.fits_in_digits = function (num) {
      const magnitude = base_instance.helpers.magnitude(base_instance.decimal_digits + base_instance.integer_digits);
    ...
    const stored_magnitude = base_instance.helpers.magnitude(base_instance.decimal_digits);
