...
(function(exports, node) {
  ...
  function createFixedpointSecretShare(jiff_instance, share) {
    ...
    var old_smult = share.smult;
    var old_cdiv = share.cdiv;
    var old_sdiv = share.sdiv;
    ...
    share.sadd = function(o) {
      if (!(o.jiff === self.jiff)) throw "Fixedpoint: shares do not belong to the same instance ("+op+")";
      if (!share.jiff.Zp_equals(share, o)) throw "Fixedpoint: shares must belong to the same field ("+op+")";
      ...
      if(decimal_accuracy_difference != 0) {
        ...
        if(share2.free_digits >= decimal_accuracy_difference) {
          ...
          var magnitude = self.jiff.helpers.magnitude(decimal_accuracy_difference);
          share2 = share2.old_cmult(magnitude);
          ...
          var magnitude = self.jiff.helpers.magnitude(decimal_accuracy_difference);
          share1 = share.old_cdiv(magnitude);
        ...
        else if(share2.free_digits >= original_accuracy - share2.decimal_digits) {
    ...
    share.cmult = function(cst) {
      ...
      var result = old_cmult(cst);
      result.integral_digits = share.integral_digits;
      result.decimal_digits = share.decimal_digits * 2;
      result.free_digits = share.free_digits - share.decimal_digits;
      return result;
    }
  ...
  function make_jiff(base_instance, options) {
    ...
    base_instance.open = function(share, parties, op_ids) {
      ...
      return promise.then(function(v) {
        if(share.decimal_digits > share.original_accuracy) {
          ...
          v = base_instance.helpers.floor(base_instance.helpers._div(v, reduce_magnitue));
        }
    ...
    base_instance.receive_open = function(parties, threshold, Zp, op_ids, decimal_digits, integral_digits) {
      ...
      if(integral_digits == null) integral_digits = base_instance.integral_digits;
