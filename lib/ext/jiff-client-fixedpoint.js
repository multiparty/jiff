...
(function (exports, node) {
  function createFixedpointSecretShare(jiff_instance, share, share_helpers) {
    ...
    share.smult = function (o, op_id) {
      ...
      if (share.jiff.modules.indexOf('negativenumber') > -1) {
    ...
    /**
     * Remainder with two shares (self % o). Behavior is identical to javascript's built in % operator with respect to floating numbers:
    ...
    share.smod = function (o, l, op_id) {
      ...
      var floorQuotient;
      if (share.jiff.free_digits >= share.jiff.decimal_digits) {
        floorQuotient = share.sdiv(o.cmult(magnitude), l, op_id+':sdiv');
      } else {
        floorQuotient = share.sdiv(o, l, op_id+':sdiv');
        floorQuotient = floorQuotient.cdiv(magnitude, op_id+':sdiv');
      }

      var result = share.ssub(floorQuotient.legacy.smult(o, op_id+':smult'));
      return result;
    };
    ...
    share.floor = function (o, op_id) {
      ...
      var magnitude = share.jiff.helpers.magnitude(share.jiff.decimal_digits);
      return share.cdiv(magnitude, op_id).cmult(magnitude);
    };
