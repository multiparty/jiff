  ...
  function createFixedpointSecretShare(jiff_instance, share) {
    ...
    share.if_else = function (val1, val2, op_id) {
      if (share.isConstant(val1)) {
        val1 = magnitude.times(val1).decimalPlaces(0, share.jiff.helpers.BigNumber.ROUND_FLOOR);
      }
      if (share.isConstant(val2)) {
        val2 = magnitude.times(val2).decimalPlaces(0, share.jiff.helpers.BigNumber.ROUND_FLOOR);
      }
