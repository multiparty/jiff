...
(function(exports, node) {
  ...
  function negativenumber_secret_share(negativenumber_jiff, int_part, fraction_part) {
    ...
    this.smult_test = function(o) {

      var rx_times_ry = this.smult(o);
    

      // var rx_plus_ry = self.sadd(o);

      // var a_2_plus_a = self.jiff.options.offset.times(self.jiff.options.offset).plus(self.jiff.options.offset)
      
      // var result = rx_times_ry.sadd(rx_plus_ry);

      return new negativenumber_secret_share(self.jiff, this.int_part, this.fraction_part);
