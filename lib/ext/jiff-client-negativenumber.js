...
(function (exports, node) {
  ...
  function make_jiff(base_instance, options) {
    ...
    jiff.preprocessing_function_map['abs'] = [
      { op: 'clt', op_id: ':clt' },
      { op: 'smult', op_id: ':smult' }

    ];
    jiff.preprocessing_function_map['cdivfac'] = [
      { op: 'abs', op_id: ':abs' },
      { op: 'smult', op_id: ':cor1' }
    ];
    jiff.preprocessing_function_map['cdiv-negativenumber'] = jiff.preprocessing_function_map['cdiv'];
    jiff.preprocessing_function_map['cdiv'] = [
      { op: 'abs', op_id: ':abs' },
      { op: 'cdiv-negativenumber', op_id: ':cdiv' },
      { op: 'smult', op_id: ':cor1' },
      { op: 'sneq', op_id: ':floor:sneq' },
      { op: 'smult', op_id: ':floor:and' },
    ];
    /* HOOKS */
