...
(function (exports, node) {
  ...
  function createSecretShare(jiff, share, share_helpers) {
     ...
     * @param {Boolean} floor_down - [optional] round down or round towards zero (the default).
    ...
    share.smod = function (o, l, op_id, floor_down) {
      ...
      var quotient;
      if (floor_down == null) {
        quotient = share.sdiv(o, l, null, false);
      } else {
        quotient = share.sdiv(o, l, null, floor_down);
      }

      var result = share.ssub(quotient.smult(o));
