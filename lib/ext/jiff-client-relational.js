...
(function (exports, node) {
  ...
  function make_jiff(base_instance, options) {
     ...
     * It should return 0 if the list is empty but right now it throws an error. 
     * @method countif
     * @memberof jiff-instance.helpers
     * @instance
     * @param {Array} arr - array of values
     * @param {function(elt)} fun - boolean function that operates on array elements
     * @return {SecretShare | null } - number of elements in arr that satisfy fun (null if array is empty)
     */
