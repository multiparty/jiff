...
(function (exports, node) {
  ...
  function socketToRestAPI(jiff) {
    ...
    jiff.socket.safe_disconnect = function (free, callback) {
      ...
      jiff.socket.empty_deferred.then(function () {
  ...
  exports.make_jiff = function (jiff, options) {
    ...
    jiff.restReceive = function (error, body) {
      ...
      if (!body['success']) {
        execute_listeners(jiff, 'error', body['error']);
        return;
      }
      ...
      if (jiff.socket.mailbox.current.initialization == null && jiff.socket.mailbox.current.messages.length === 0) {
        if (jiff.socket.empty_deferred != null) {
