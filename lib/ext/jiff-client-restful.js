...
(function (exports, node) {
  ...
  function socketToRestAPI(jiff) {
    ...
    jiff.socket.safe_disconnect = function (free, callback) {
      jiff.socket.empty_deferred = $.Deferred();
      if (free) {
        jiff.free();
      }
  ...
  exports.make_jiff = function (jiff, options) {
    ...
    options.flushInterval = (options.flushInterval == null ? 2000 : options.flushInterval);
    ...
    jiff.restFlush = function () {
      ...
      var body = {
        ...
        messages: jiff.socket.mailbox.current.messages,
