...
module.exports = {
  ...
  make_jiff: function (base_instance, options) {
    ...
    // Hooks
    jiff.hooks.afterInitialize.push(function (computation_id, party_id, party_count, msg, return_message) {
    ...
    jiff.hooks.afterPublicKey.push(function (computation_id, party_id, msg, return_message) {
      if (jiff.restful.keys_changed[computation_id] != null) {
