...
(function (exports, node) {
  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    /**
     * Share an n-dimentional array of secrets
     * @method share_ND_array
     * @memberof jiff-instance
     * @instance
     * @param {Array} secrets - the n-dimentional array of numbers to share (this party's input)
     ...
     * @returns {Array} an n-dimentional array with elements of type SecretShare,
     *                  corresponding to the secrets in the original passed array
     */
    jiff.share_ND_array = function (secrets, threshold, receivers_list, senders_list, Zp, share_id) {
        ...
        if (typeof(secrets.length) === "undefined" || secrets.length == 0) {
            ...
            for (var i = 0; i < shares.length; i++) {
                deferred_array.push(jiff.share_ND_array(secrets[i], receivers_list, senders_list, Zp, share_id + ':' + i));
            }
     ...
     * @memberof jiff-instance
     * @instance
     * @param {SecretShare|SecretShare[]} shares - the (multi)dimentional array of shares, or just a single share
     ...
     * @returns {SecretShare|SecretShare[]} shares - the (multi)dimentional array of shares, or just a single share
     */
    ...
    /**
     * Opens an n-dimentional array of secret shares.
     * @method open_ND_array
     * @memberof jiff-instance
     * @instance
     * @param {SecretShare|SecretShare[]|SecretShare[][]|...} shares - an n-dimentional array containing this party's shares of the secrets to reconstruct.
     * @param {Array[]} [parties=all_parties] - an array with party ids (1 to n) of receiving parties.
     * @param {string|number|object} [op_ids=auto_gen()] - an optional ID/Tag associated with these open operations
     * @returns {promise} a (JQuery) promise to ALL the open values of the secret, the promise will yield
     *                    an n-dimentional array of values, each corresponding to the given share in the shares parameter
     *                    at the same index. In the case where different values are opened to different parties, the order
     *                    of the values will be preserved, but not the indices, there will be no blanks in the resulting arrays,
    ...
    jiff.open_ND_array = function (shares, parties, op_id) {
        ...
        if (typeof(shares.length) === "undefined" || shares.length == 0) {
            ...
            for (var i = 0; i < shares.length; i++) {
                deferred_array.push(jiff.open_ND_array(shares[i], parties, op_id + ':open_ND_array:' + i));
            }
