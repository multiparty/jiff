  ...
  function secret_share(jiff, ready, promise, value, holders, threshold, Zp, id) {
    ...
    self.smult_bgw = function(o, op_id) {
      ...
      Promise.all([self.promise, o.promise]).then(
        function () {
          // Get Shares  of z
          var zi =  self.jiff.helpers.mod(self.value * o.value, self.Zp);
          //var zi = self.value*o.value;
          var zi_shares = self.jiff.share(zi, self.threshold, null, null, null);
          ...
          Promise.all(promises).then(
            function () {
              ...
              zi_prime = jiff.coerce_to_share(zi_prime);
    ...
    self.sdiv = function(o, l, op_id) {
      ...
      var q = self.jiff.server_generate_and_share({"number": 0}, self.holders, self.threshold, self.Zp, op_id+":number");
      var a = self; // dividend
      ...
      (function one_bit(i) {
        ...
        var tmpFits = o.clteq(Math.floor(o.Zp / power), op_id+":c<="+i);
