...
(function (exports, node) {
  ...
  function secret_share(jiff, ready, promise, value, holders, threshold, Zp, id) {
    ...
    self.change_threshold = function (shares, n, op_id) {
      ...
      console.log('in change_threshold');
      ...
      //var new_share = exports.sharing_schemes.shamir_share(zi_prime, self.holders, n, self.Zp);
      return zi_prime;
    };
