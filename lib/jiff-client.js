...
function JIFFClient(hostname, computation_id, options) {
   ...
   * @type {!Object}
   */
  console.log("Assigning to this.options:");
  console.log(options);
  ...
  //    * @type {!GuardedSocket}
  //    */
  //   this.socket = guardedSocket(jiffClient);
  // } else {
  //   this.socket = internalSocket(jiffClient, options.__internal_socket);
  // }
  ...
  function socketConnect (JIFFClientInstance) {
    if (options.__internal_socket == null) {
      /**
       * Socket wrapper between this instance and the server, based on sockets.io
       * @type {!GuardedSocket}
       */
      console.log("Socket Connect This:");
  ...
  this.connect = function () {
    ...
    console.log("This.connect this:");
    console.log(this);
    var JIFFClientInstance = this;
    if (jiffClient.sodium_ === false) {
      socketConnect(JIFFClientInstance);
    } else {
