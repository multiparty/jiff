...
(function (exports, node) {
  ...
  function make_jiff(hostname, computation_id, options) {
     ...
     * @method beaver_bgw
     * @param {number} x - the party's x value, likely sampled uniformly, will be built into a collective, secret a [optional]
     * @param {number} y - the party's y value, likely sampled uniformly, will be built into a collective, secret b [optional]
