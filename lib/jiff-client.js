  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    jiff.preprocessing_function_map = {
      base: {
        ...
        lt_halfprime : [
          {
            op: 'generate_bit_sequence',
            op_id: ':bitsequence',
            params: {
              bit: true
            },
            handler: function (threshold, receivers_list, compute_list, Zp, op_id, params) {
        ...
        clt_bits: [
          {
            op: 'sor_bit',
            op_id: ':sOR:',
            count: function (threshold, receivers_list, compute_list, Zp, op_id, params) {
              var bitLength = jiff.helpers.bLog(Zp, 2).toString(10);
              bitLength = Math.floor(Number(bitLength));
              return bitLength;
            }
        ...
        sdiv: [
          ...
          {op: 'slteq', op_id: ':slteq' /* count: copy of above function */},
          {op: 'smult', op_id: ':smult1:' /* count: copy of above function */},
          {op: 'smult', op_id: ':smult2:' /* count: copy of above function */}
        ],
    ...
    jiff.preprocessing_function_map['base']['sdiv'][1]['count'] = jiff.preprocessing_function_map['base']['sdiv'][0]['count'];
    jiff.preprocessing_function_map['base']['sdiv'][2]['count'] = jiff.preprocessing_function_map['base']['sdiv'][0]['count'];
    jiff.preprocessing_function_map['base']['sdiv'][3]['count'] = jiff.preprocessing_function_map['base']['sdiv'][0]['count'];
     ...
     * @return {bool} true if the op uses preprocessing, false otherwise.
     */
