...
(function (exports, node) {
  ...
  function make_jiff(hostname, computation_id, options) {
     ...
     *                          This must be one of 3 cases:
     *                          1. null:                       open all shares to all parties.
     *                          2. { parties: [parties] }         opens all shares (all rows) to all the parties specified in the array.
     ...
     *                                                         another parties ids array. default value for outer parties array is all parties.
