...
(function(exports, node) {
  ...
  function secret_share(jiff, ready, promise, value, holders, threshold, Zp, id) {
    ...
    self.cdiv = function(cst, op_id) {
      ...
      var ZpOVERc = Math.floor(self.Zp / cst);
      ...
      self.jiff.open(noisyX, noisyX.holders, op_id+":open").then(function(noisyX) {
        ...
        // if we did not wrap
        var noWrapDiv = Math.floor(noisyX/cst);
        ...
        // if we wrapped
        var wrapDiv = Math.floor((noisyX + self.Zp)/cst);
