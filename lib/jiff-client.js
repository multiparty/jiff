...
(function (exports, node) {
  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    jiff.share_ND_array = function (secrets, skeletons, threshold, receivers_list, senders_list, Zp, share_id) {
      ...
      let share_from_skeleton = function (sender, __skeleton) {
        ...
        (function __share_ND_array(secrets, share_id) {
          if (typeof(secrets) === 'number' || secrets == null) {
            ...
            return Promise.resolve(jiff.internal_share(secrets, threshold, receivers_list, [sender], Zp, 'share:' + share_id)[sender]);
      ...
      return isReceiving ? Promise.all(all_promises) : Promise.resolve({});
    }
