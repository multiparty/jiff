...
(function(exports, node) {
  ...
  function jiff_share_array(jiff, array, callback, padding, /*parameters for the 
    ...
    max.open(function(max_opened, failure) {
  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    jiff.listen = function(tag, handler) {
      ...
      jiff.custom_messages_mailbox[tag] = null;
    }
     ...
     * @returns {promise} the promise of the array of shares.
     */
    jiff.share_array = function(array, callback, threshold, receivers_list, senders_list, Zp, share_id) {
      return jiff_share_array(jiff, array, callback, padding, threshold, receivers_list, senders_list, Zp, share_id);
    }
