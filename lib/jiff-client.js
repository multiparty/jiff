...
// utils and helpers
const constants = require('./client/util/constants.js');
const Helpers = require('./client/util/helpers.js');
const Utils = require('./client/util/utils.js');
const LinkedList = require('../build/linkedlist.js');

// hooks
const Hooks = require('./client/arch/hooks.js');

// extensions management
const extensions = require('./client/arch/extensions.js');

// op ids and other counters
const counters = require('./client/arch/counters.js');
...
// secret shares
const SecretShareMetaClass = require('./client/share.js');
const share_helpers = require('./client/shareHelpers.js');

// jiff client instance API
const api = require('./client/api.js');

// preprocessing
const PreprocessingMap = require('./client/preprocessing/map.js');
const PreprocessingAPI = require('./client/preprocessing/api.js');
const PreprocessDaemon = require('./client/preprocessing/daemon.js');
...
function JIFFClient(hostname, computation_id, options) {
   ...
   * @type {!Linkedlist}
   */
  this.currentPreprocessingTasks = new LinkedList();
  ...
  // Preprocessing
  this.preprocess = new PreprocessingMap(this);
  this.preprocess.api = new PreprocessingAPI(this);
  this.preprocess.daemon = new PreprocessDaemon(this);
  ...
  this.socketConnect = function (JIFFClientInstance) {
    if (options.__internal_socket == null) {
       ...
       * @type {!GuardedSocket}
       */
      JIFFClientInstance.socket = new GuardedSocket(JIFFClientInstance);
    } else {
    ...
    JIFFClientInstance.socketEvent = new SocketEvent(JIFFClientInstance);
