...
(function (exports, node) {
  ...
  function secret_share(jiff, ready, promise, value, holders, threshold, Zp, id) {
    ...
    self.sdiv = function (o, l, op_id) {
      ...
      var deferred_result = new Deferred();
      ...
      Promise.all(promise_bits).then(function (decomposed_bits) {
        var dividend_bits = decomposed_bits[0];
        var divisor_bits = decomposed_bits[1];
        ...
        deferred_result.resolve(quotient);
      });


      return deferred_result.promise;  // BUG: FIX PROMISE/CALLBACK
    };
