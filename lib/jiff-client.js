...
(function (exports, node) {
  ...
  function jiff_triplet(jiff, receivers_list, threshold, Zp, triplet_id) {
    ...
    if (jiff.id === 's1') {
      ...
      jiff.socket.safe_emit('triplet', jiff.hooks.encryptSign(jiff, msg, jiff.keymap['s1'], jiff.secret_key, 'triplet'));
    }
  ...
  function jiff_server_share_number(jiff, options, receivers_list, threshold, Zp, number_id) {
    ...
    if (jiff.id === 's1') {
      ...
      jiff.socket.safe_emit('number', jiff.hooks.encryptSign(jiff, msg, jiff.keymap['s1'], jiff.secret_key, 'number'));
    }
  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    if (options.sodium !== false) {
       ...
       */
      // eslint-disable-next-line no-undef
      jiff.sodium_ready = sodium.ready;
    }
