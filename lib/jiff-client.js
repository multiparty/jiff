...
(function (exports, node) {
  ...
  function make_jiff(hostname, computation_id, options) {
     ...
     * Costs linear number of rounds in the number of bits, and 2 * |bits| + |number of 1s in constant bits| total communication.
     * @method rejection_sampling
     * @memberof jiff-instance.protocols.bits
     * @instance
    ...
    jiff.protocols.bits.cadd = function (bits, constant, op_id) {
      if (op_id == null) {
        op_id = self.jiff.counters.gen_op_id('bits.cadd', self.holders);
      }
     ...
     * Costs a linear number of rounds in the number of bits, and 2 * |bits| total communication.
     * @method csubr
     * @memberof jiff-instance.protocols.bits
     * @instance
     * @param {number} constant - the constant.
    ...
    jiff.protocols.bits.csubl = function (bits, constant, op_id) {
      if (op_id == null) {
        op_id = self.jiff.counters.gen_op_id('bits.csubl', self.holders);
      }
    ...
    jiff.protocols.bits.csubr = function (constant, bits, op_id) {
      if (op_id == null) {
        op_id = self.jiff.counters.gen_op_id('bits.csubr', self.holders);
      }
