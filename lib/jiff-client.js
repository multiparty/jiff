...
(function (exports, node) {
   ...
   * @param {number} threshold - the min number of parties needed to reconstruct the secret, defaults to all the receivers. [optional]
   ...
   * @param {number} Zp - the mod (if null then the default Zp for the instance is used). [optional]
   ...
   * @param {number} threshold - the min number of parties needed to reconstruct the triplet.
   * @param {number} Zp - the mod (if null then the default Zp for the instance is used). [optional]
   ...
   * @param {Array} receivers_list - array of party ids that want to receive the triplet shares, by default, this includes all parties. [optional]
   * @param {number} threshold - the min number of parties needed to reconstruct the number.
   * @param {number} Zp - the mod (if null then the default Zp for the instance is used). [optional]
  ...
  function jiff_share_array(jiff, array, lengths, threshold, receivers_list, senders_list, Zp, share_id) {
    ...
    if (lengths == null) {
      ...
      if (senders_list.indexOf(jiff.id) > -1) {
        ...
        jiff.emit(share_id + 'length', receivers_list, array.length.toString());
      }

      jiff.listen(share_id + 'length', function (sender, message) {
        lengths[sender] = parseInt(message);
        total++;
  ...
  function secret_share(jiff, ready, promise, value, holders, threshold, Zp, id) {
     ...
     * @param {string} op_id - the operation id which is used to identify this operation.
     *                         This id must be unique, and must be passed by all parties to the same instruction, to
     *                         ensure that corresponding instructions across different parties are matched correctly [optional].
     * @return {SecretShare} this party's share of the result.
     * @memberof SecretShare
     */
     ...
     * @param {string} op_id - the operation id which is used to identify this operation.
     *                         This id must be unique, and must be passed by all parties to the same instruction, to
     *                         ensure that corresponding instructions across different parties are matched correctly [optional].default ids suffice when all parties execute the
     *                         instructions in the same order. [optional]
     * @return {SecretShare} this party's share of the result, the final result is 1 if this > cst, and 0 otherwise.
     * @memberof SecretShare
     */
   ...
   * @param {object} options - javascript object with additional options. [optional],
  ...
  function make_jiff(hostname, computation_id, options) {
     ...
     *                                        You can safetly ignore this unless you have multiple opens each containing other opens.
     ...
     * @param {number} threshold - the min number of parties needed to reconstruct the secret, defaults to all the senders. [optional]
     * @param {number} Zp - the mod (if null then the default Zp for the instance is used). [optional]
