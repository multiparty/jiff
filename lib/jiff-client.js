...
(function(exports, node) {
   ...
   *
   */
  function jiff_compute_shares(secret, party_count, parties_list, threshold, Zp, random) {
    ...
    for(var i = 1; i <= t; i++) polynomial[i] = random(Zp);
  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    if(jiff.hooks.computeShares == null) jiff.hooks.computeShares = function(instance, secret, parties_list, threshold, Zp) { return jiff_compute_shares(secret, instance.party_count, parties_list, threshold, Zp, instance.helpers.random); };
    ...
    jiff.helpers.get_party_number = function(party_id) {
      return get_party_number(jiff.party_count, party_id);
    };
  ...
  exports.sharing_schemes = { 'shamir_share': function(instance, secret, parties_list, threshold, Zp) { return jiff_compute_shares(secret, instance.party_count, parties_list, threshold, Zp, instance.helpers.random); }, 'shamir_reconstruct': jiff_lagrange };
