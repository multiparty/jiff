...
(function (exports, node) {
  ...
  function secret_share(jiff, ready, promise, value, holders, threshold, Zp, id) {
    ...
    self.sdiv = function (o, l, op_id) {
      ...
      return self.div_helper(o, l, 'div', op_id);
    };

    /**
     * Helper function for integer divison with two shares (self / o)
     * @method div_helper
     * @param {secret-share} o - the share to divide by.
     * @param {number} l - the maximum bit length of the answer. [optional]
     * @param {string} op_id - the operation id which is used to identify this operation.
     *                         This id must be unique, and must be passed by all parties to the same instruction, to
     * @param {string} operation - if "div" or null, operation returns result of the division, otherwise returns the remainder of the operation
     *                         ensure that corresponding instructions accross different parties are matched correctly [optional].
     * @return {secret-share} this party's share of the result, either the result of the division or the remainder depending on which operation is specified
     * @memberof secret-share
     */
    self.div_helper = function (o, l, operation, op_id) {
      if (!(o.jiff === self.jiff)) {
        throw 'shares do not belong to the same instance (!=)';
      }
      if (!self.jiff.helpers.Zp_equals(self, o)) {
      ...
      // if no operation is specified, default to division
      if (operation == null) {
        operation = 'div';
      }
      ...
      (function one_bit(i) {
        try {
          if (i >= l) {
            ...
            //otherwise we just want to return the remainer / mod value
            else {
              if (a.ready) {
                final_deferred.resolve(a.value);
              } else {
          ...
          console.log(err); for (var i = 0; true; i ++) {
