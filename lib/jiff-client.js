...
(function (exports, node) {
  ...
  function make_jiff(hostname, computation_id, options) {
     ...
     * @memberof jiff-instance
     * @instance
     * @param {String} the JSON string representing and array of the secret shares' known values/coefficients
     ...
     */
    jiff.parse = function (json, holders, threshold, Zp) {
        ...
        if (Object.keys(json).length == 0) {
            shares = jiff.secret_share(jiff, true, null, json, holders, threshold, Zp/*, String(json)*/);
        } else {
            for (var i = 0; i < json.length; i++) {
                shares[i] = jiff.parse(json[i], holders, threshold, Zp);
            }
        }
        return shares;
    }
