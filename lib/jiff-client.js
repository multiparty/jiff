...
(function(exports, node) {
   ...
   */
  function symmetric_key_encrypt(message, symmetric_key) {
   ...
   */
  function symmetric_key_decrypt(ciphertext, symmetric_key, nonce) {
    try {
    ...
    var decryptedText = sodium.crypto_aead_xchacha20poly1305_ietf_decrypt(
      null,
      ciphertext,
      null,
      nonce,
      symmetric_key //symmetric_key_map[computation_id][party_id]
    );
