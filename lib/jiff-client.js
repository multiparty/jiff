  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    jiff.protocols.bits.rejection_sampling = function (lower_bound, upper_bound, threshold, compute_list, Zp, op_id) {
      ...
      (function resample(reject_count) {
        ...
        var cmp = jiff.protocols.bits.clt(bits, range, op_id + ':bits.cgteq');
    ...
    jiff.protocols.bits.sdiv = function (bits1, bits2, op_id) {
      ...
      var remainder = many_secret_shares(jiff, bits2.length, bits1[0].holders, Math.max(bits1[0].threshold, bits2[0].threshold), bits1[0].Zp, op_id + ':remainder');
    ...
    jiff.protocols.bits.cdivl = function (bits, constant, op_id) {
      ...
      var remainder = many_secret_shares(jiff, Math.ceil(jiff.helpers.bLog(constant, 2)), bits[0].holders, bits[0].threshold, bits[0].Zp, op_id + ':remainder');
      var remainderDeferreds = remainder.deferreds;
      remainder = remainder.shares;
    ...
    jiff.protocols.bits.cdivr = function (constant, bits, op_id) {
      ...
      var remainder = many_secret_shares(jiff, bits.length, bits[0].holders, bits[0].threshold, bits[0].Zp, op_id + ':remainder');
      var remainderDeferreds = remainder.deferreds;
      remainder = remainder.shares;
