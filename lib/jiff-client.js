...
(function (exports, node) {
  ...
  function make_jiff(hostname, computation_id, options) {
    ...
    jiff.protocols.beaver_bgw = function (jiff_instance, x, y, receivers_list, threshold, Zp, triplet_id) {
      ...
      var final_deferred_c  = $.Deferred();
      var final_promise_c = final_deferred_c.promise();
      var c_share = jiff_instance.secret_share(jiff, false, final_promise_c, undefined, receivers_list, threshold, Zp, 'share:'+triplet_id);
