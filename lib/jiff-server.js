...
module.exports = {
  ...
  make_jiff: function(http, options) {
    ...
    jiff.request_triplet_share = function(msg, computation_id, from_id) {
      ...
      if(all_triplets[triplet_id] == null) { // Generate Triplet.
        ...
        var a_shares = client.jiff_compute_shares(a, totalparty_map[computation_id], receivers, Zp);
        var b_shares = client.jiff_compute_shares(b, totalparty_map[computation_id], receivers, Zp);
        var c_shares = client.jiff_compute_shares(c, totalparty_map[computation_id], receivers, Zp);
    ...
    jiff.request_number_share = function(msg, computation_id, from_id) {
      ...
      if(all_numbers[number_id] == null) { // Generate shares for number.
        ...
        // Compute shares
        all_numbers[number_id] = client.jiff_compute_shares(number, totalparty_map[computation_id], receivers, Zp);
      }
  ...
  create_computation_instance: function(jiff, computation_id) {
    ...
    computation_instance.share = function(secret, receivers_list, senders_list, Zp) {
      return client.jiff_share(computation_instance, secret, receivers_list, senders_list, Zp);
    };
    ...
    computation_instance.generate_and_share_random = function(Zp) {
      return client.jiff_share_all_number(computation_instance, Math.floor(Math.random() * Zp), Zp);
    };
    computation_instance.generate_and_share_zero = function(Zp) {
      return client.jiff_share_all_number(computation_instance, 0, Zp);
    };
    ...
    computation_instance.triplet = function(receivers_list, Zp) {
      return client.jiff_triplet(computation_instance, receivers_list, Zp);
    };
    computation_instance.server_generate_and_share = function(options, receivers_list, Zp) {
      return client.jiff_server_share_number(computation_instance, options, receivers_list, Zp)
    };
