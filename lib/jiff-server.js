...
module.exports = {
  ...
  make_jiff: function(http, options) {
    ...
    var establish_server_side_connections = options.establish_server_side_connections;
    ...
    io.on('connection', function(socket) {
      ...
      socket.on('open', function(msg) {
        ...
        json_msg["establish_server_side_connections"] = establish_server_side_connections
