  ...
  make_jiff: function(http, options) {  
    ...
    jiff.request_triplet_share = function(msg, computation_id, from_id) {
      ...
      if(all_triplets[triplet_id] == null) { // Generate Triplet.
        ...
        var a_shares = client.jiff_compute_shares(null, a, totalparty_map[computation_id], receivers, threshold, Zp);
        var b_shares = client.jiff_compute_shares(null, b, totalparty_map[computation_id], receivers, threshold, Zp);
        var c_shares = client.jiff_compute_shares(null, c, totalparty_map[computation_id], receivers, threshold, Zp);
    ...
    jiff.request_number_share = function(msg, computation_id, from_id) {
      ...
      if(all_numbers[number_id] == null) { // Generate shares for number.
        ...
        // Compute shares
        all_numbers[number_id] = client.jiff_compute_shares(null, number, totalparty_map[computation_id], receivers, threshold, Zp);
      }
