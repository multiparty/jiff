...
function manage_mailboxes(jiff) {
  ...
  jiff.emit_ack = function (label, msg, computation_id, to_id, callback) {
  ...
  jiff.safe_emit = function (label, msg, computation_id, to_id) {
    ...
    jiff.emit_ack(label, msg, computation_id, to_id, function () {
  ...
  jiff.resend_mailbox = function (computation_id, party_id) {
    ...
    for (var i = 0; i < mailbox.length; i++) {
      ...
      jiff.emit_ack(label, msg, computation_id, party_id, callback(store_id));
    }
  };
}
