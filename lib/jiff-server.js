...
exports.make_jiff = function (http, options) {
  ...
  jiff.initializeParty = function (computation_id, party_id, party_count, msg) {
    ...
    jiff.execute_array_hooks('afterInitialize', [computation_id, party_id, party_count, msg], -1);

    return { success: true, message: { party_id: party_id, party_count: party_count } };
  };
  ...
  jiff.public_key = function (computation_id, party_id, msg) {
    ...
    // validate parameters
    try {
      jiff.execute_array_hooks('onPublicKey', [computation_id, party_id, msg], -1);
    } catch (err) {
      return { success: false, error: typeof(err) === 'string' ? err : err.message };
    }
  ...
  jiff.share = function (computation_id, from_id, msg) {
    ...
    try {
      msg = jiff.execute_array_hooks('onOperation', ['share', computation_id, from_id, msg], 3);
    } catch (err) {
      return { success: false, error: typeof(err) === 'string' ? err : err.message };
    }
  ...
  jiff.open = function (computation_id, from_id, msg) {
    ...
    try {
      msg = jiff.execute_array_hooks('onOperation', ['open', computation_id, from_id, msg], 3);
    } catch (err) {
      return { success: false, error: typeof(err) === 'string' ? err : err.message };
    }
  ...
  jiff.triplet = function (computation_id, from_id, msg) {
    ...
    try {
      msg = jiff.execute_array_hooks('onOperation', ['triplet', computation_id, from_id, msg], 3);
    } catch (err) {
      return { success: false, error: typeof(err) === 'string' ? err : err.message };
    }
  ...
  jiff.number = function (computation_id, from_id, msg) {
    ...
    try {
      msg = jiff.execute_array_hooks('onOperation', ['number', computation_id, from_id, msg], 3);
    } catch (err) {
      return { success: false, error: typeof(err) === 'string' ? err : err.message };
    }
  ...
  jiff.custom = function (computation_id, from_id, msg) {
    ...
    try {
      msg = jiff.execute_array_hooks('onOperation', ['custom', computation_id, from_id, msg], 3);
    } catch (err) {
      return { success: false, error: typeof(err) === 'string' ? err : err.message };
    }
...
function initialize_hooks(jiff, options) {
  ...
  if (jiff.hooks.onPublicKey == null) {
    jiff.hooks.onPublicKey = [];
  }
  if (jiff.hooks.onOperation == null) {
    jiff.hooks.onOperation = [];
  }
