...
function JIFFServer(http, options) {
  ...
  this.cryptoProviderHandlers = new CryptoProviderHandlers(this, options);
}

// manage state
JIFFServer.prototype.initComputation = function (computation_id, party_count) {
...
// fill in prototype
JIFFServer.prototype.helpers = Object.assign({}, sampling, helpers);
