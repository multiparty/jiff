...
module.exports = function (jiffServer) {
  ...
  jiffServer.handlers.ot_share = function (computation_id, from_id, msg) {
    // jiffServer.hooks.log(jiffServer, 'share ot msg from', computation_id, '-', from_id, ' : ', msg);
    ...
    msg = jiffServer.hooks.execute_array_hooks('afterOperation', [jiffServer, 'share', computation_id, from_id, msg], 4);
    jiffServer.safe_emit('OT', JSON.stringify(msg), computation_id, to_id);
