    ...
    this.io.on('connection', function (socket) {
      ...
      function initialization(msg) {
        ...
        if (output.success) {
          ...
          jiff.socketMaps.computationId[socket] = computation_id;
          jiff.socketMaps.partyId[socket] = output.message.party_id;
          ...
          socket.send(JSON.stringify( { socketProtocol: 'error', errorProtocol: 'initialization', error: output.error } ));
      ...
      function share(msg, callback) {
        ...
        var computation_id = jiff.socketMaps.computationId[socket];
        var from_id = jiff.socketMaps.partyId[socket];
       ...
       * TODO: Include this socketProtocol in ever message sent with sockets through jiff
       * */
