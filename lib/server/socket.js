  ...
  JIFFServer.prototype.initSocket = function () {
    ...
    this.io.on('connection', function (socket) {
      ...
      socket.on('share', function (msg, callback) {
        ...
        const output = jiff.handlers.share(computation_id, from_id, json_msg);
        if (!output.success) {
      ...
      socket.on('open', function (msg, callback) {
        ...
        const output = jiff.handlers.open(computation_id, from_id, json_msg);
        if (!output.success) {
      ...
      socket.on('custom', function (msg, callback) {
        ...
        const output = jiff.handlers.custom(computation_id, from_id, json_msg);
        if (!output.success) {
  ...
  JIFFServer.prototype.closeAllSockets = function () {
    ...
    if (jiff.io) {
      ...
      socketIds.forEach(function (socketId) {
        const socket = jiff.io.sockets.sockets.get(socketId);
        if (socket) {
