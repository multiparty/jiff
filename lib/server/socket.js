...
module.exports = function (JIFFServer) {
  ...
  JIFFServer.prototype.initSocket = function () {
    ...
    this.io.on('connection', function (socket) {
      ...
      socket.on('OT',function (msg,callback) {
        ...
        var output = jiff.handlers.ot_share(computation_id, from_id, json_msg);
        if (!output.success) {
          var errorMsg = JSON.stringify({label: 'OT', error: output.error});
