...
jiff_instance.sodium.ready.then(function () {
  var computation_instance = jiff_instance.compute('1', {party_count: 10000});
  ...
  computation_instance.wait_for(['1'], function () {
    ...
    computation_instance.listen('begin', function (_, party_count) {
      ...
      computation_instance.emit('number', [ 1 ], parties_number.toString());
